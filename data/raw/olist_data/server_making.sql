...
LOAD DATA LOCAL INFILE 'C:\Users\usuario\Desktop\olist_data\olist_customers_dataset.csv'
...
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
#esto de aca arriba no anda (despúes en un archivo aparte si lo voy a usar, no en workbenc)

#Cargo todas las tablas con el wizard

SELECT * FROM orders
 LIMIT 10;
 
 #Hay errores en el formateo de algunas tablas (orders ej hay algunas vacías.)
 #vamos a crear una tabla raw para encargarnos de esto
...
#ahora importamos aca los datos
...
-- si tiene otras tablas hijas de orders, agregarlas también:
...
LOAD DATA LOCAL INFILE 'C:/Users/usuario/Desktop/olist_data/olist_orders_dataset.csv'
INTO TABLE orders
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
...
LOAD DATA LOCAL INFILE 'C:/Users/usuario/Desktop/olist_data/olist_products_dataset.csv'
INTO TABLE products
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
...
LOAD DATA LOCAL INFILE 'C:/Users/usuario/Desktop/olist_data/olist_order_items_dataset.csv'
...
#volvamoslo a hacer pero con staging
...
LOAD DATA LOCAL INFILE 'C:/Users/usuario/Desktop/olist_data/olist_order_payments_dataset.csv'
...
LOAD DATA LOCAL INFILE 'C:/Users/usuario/Desktop/olist_data/olist_order_reviews_dataset.csv'
...
LOAD DATA LOCAL INFILE 'C:/Users/usuario/Desktop/olist_data/olist_sellers_dataset.csv'
...
LOAD DATA LOCAL INFILE 'C:/Users/usuario/Desktop/olist_data/olist_geolocation_dataset.csv'
...
LOAD DATA LOCAL INFILE 'C:/Users/usuario/Desktop/olist_data/product_category_name_translation.csv'
